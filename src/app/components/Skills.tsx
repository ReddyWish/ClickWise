    ...
    <section id="skills" className="pb-24 max-md:pb-5">
        ...
        >
          <p className="font-playfair font-semibold text-4xl mb-3">
            <span className="text-white">
              {section.service} <span className="text-fuchsia-500">&</span>{" "}
              {section.costs}
            </span>
          </p>
          ...
          <div className="mt-10 mb-7">
            <ul>
              ...
              <li className="pb-2">
                💡 {section.marketing_department}
                <p className="pl-6 text-zinc-300 text-xs">
                  €6 / {section.hour} (minimum 100 hours/month)
                </p>
              </li>
              <li className="pb-2">
              ...
              <li className="pb-2">
                ...
                <p className="pl-6 text-zinc-300 text-xs">
                  €4,100 - €7,000 / {section.month}
                </p>
              </li>
              <li className="pb-2">
                💡 {section.seo}
                <p className="pl-6 text-zinc-300 text-xs">
                  €1,100 - €4,000 / {section.month}
                </p>
              </li>
              <li className="pb-2">
              ...
              <li className="pb-2">
                💡 {section.online_advertising}
                <p className="pl-6 text-zinc-300 text-xs">
                  €250 / {section.month}
                </p>
              </li>
              <li className="pb-2">
                💡 {section.reputation_management}
                <p className="pl-6 text-zinc-300 text-xs">
                  €250 / {section.month}
                </p>
              </li>
            ...
            <div className="relative z-0 ml-20 before:absolute before:-top-10 before:-left-10 before:w-full before:h-full before:border-2 before:border-fuchsia-500 before:z-[-1]">
              <div className="md:order-2 flex justify-center basis-3/5 w-full h-full relative">
                ...
                <div className="absolute z-10 w-full h-full">
                  <div className="absolute bottom-0 left-0 right-0 top-1/2 bg-gradient-to-t from-zinc-900 to-transparent opacity-75 hover:opacity-0 transition-opacity duration-500"></div>
                </div>
              </div>
            </div>
          ) : (
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">{section["experience-description"]}</p>
        </motion.div>
        ...
        >
          <div className="relative h-32">
            <div className="z-10">
              ...
              <p className="font-playfair font-semibold text-3xl mt-3">
                {section["imaginative-title"]}
              </p>
            </div>
            <div className="w-1/2 md:w-3/4 h-32 bg-yellow absolute right-0 top-0 z-[-1]" />
          </div>
          <p className="mt-5">{section["imaginative-description"]}</p>
        </motion.div>
      </div>
    </section>
  );
