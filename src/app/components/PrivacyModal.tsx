      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="privacy-policy p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-auto h-[70vh] text-gray-900 dark:text-gray-100">
            ...
            <p className="mb-4">
              Irina Shuvatova, en aplicación de la normativa vigente en materia
              de protección de datos de carácter personal, informa que los datos
              personales que se recogen a través de los formularios del sitio
              web:{" "}
              <a
              ...
              , se incluyen en los ficheros automatizados específicos de
              usuarios de los servicios de Irina Shuvatova.
            </p>
            <p className="mb-4">
              ...
              asesoramiento y otras actividades propias de Irina Shuvatova.
            </p>
            <p className="mb-4">
              Estos datos únicamente serán cedidos a administraciones públicas y
              entidades colaboradoras con el único objetivo de dar cumplimiento
              a la finalidad anteriormente expuesta.
            </p>
            <p className="mb-4">
              Irina Shuvatova adopta las medidas proporcionales conforme a la
            ...
            <p className="mb-4">
              ...
              comunicando los cambios a Irina Shuvatova.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                ...
                de Irina Shuvatova, cuyos términos y condiciones se pondrán a tu
            ...
            <p className="mb-4">
              ...
              Irina Shuvatova, salvo obligación legal.
            </p>
            <p className="mb-4">
              Como encargada de tratamiento, Irina Shuvatova se presenta como
              responsable de todo tratamiento, habiéndose comprometido al
              cumplimiento de las disposiciones normativas, de aplicación en
              materia de protección de datos, en el momento de su contratación.
            </p>
            ...
            <p className="mb-4">
              ...
              (Google Drive, Yandex.Disk, etc) o enviados a servicios y cuentas
              de correo no alojadas en{" "}
              <a
                href="https://www.click-wiser.com"
                className="text-blue-500 hover:underline"
              >
              ...
              , Irina Shuvatova no se hace responsable del incumplimiento por
            ...
            <p className="mb-4">
              Irina Shuvatova informa de que, como prestadora de servicio de
              ...
              afecta al secreto de las comunicaciones y solo podrán ser
            ...
            <p className="mb-4">
              ...
              disposición por Irina Shuvatova, aun siendo gratuitos y/o de
              disposición pública.
            </p>
            <p className="mb-4">
              Irina Shuvatova dispone de los derechos de explotación y propiedad
            ...
            <p className="mb-4">
              ...
              usuario necesitará autorización por escrito por parte de Irina
              Shuvatova, quedando prohibido al usuario acceder, modificar,
              visualizar la configuración, estructura y ficheros de los
              servidores propiedad de Irina Shuvatova, asumiendo la
            ...
            <p className="mb-4">
              ...
              intelectual de los servicios prestados por Irina Shuvatova y, en
              particular de:
            </p>
            <ul className="list-disc list-inside mb-4">
              <li>
              ...
              <li>
                ...
                juicio de Irina Shuvatova y su equipo, resulte violento,
            ...
            <p className="mb-4">
              El usuario indemnizará a Irina Shuvatova y su equipo por los
            ...
            <p className="mb-4">
              Irina Shuvatova realiza copias de seguridad de los contenidos
            ...
            <p className="mb-4">
              ...
              contenidos de los usuarios en los activos informáticos de Irina
              Shuvatova por lo que no incluyen la reposición de los contenidos
              conservados en las copias de seguridad realizadas por Irina
              Shuvatova, independientemente del motivo de su pérdida; por ello,
            ...
            <p className="mb-4">
              ...
              ninguno de los servicios ofrecidos por Irina Shuvatova, ya que su
            ...
            <p className="mb-4">
              En aplicación de la LSSI, Irina Shuvatova no enviará
            ...
            <p className="mb-4">
              ...
              previa, Irina Shuvatova sí está autorizada al envío de
              comunicaciones comerciales referentes a productos o servicios que
